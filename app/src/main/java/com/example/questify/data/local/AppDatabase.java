...
import com.example.questify.data.local.dao.PetClothingCrossRefDao;
...
@Database(
        entities = {
                ...
                PetEntity.class,
                PetClothingCrossRefEntity.class,
                ProjectEntity.class,
                TaskEntity.class,
                SubtaskEntity.class,
                UserEntity.class
...
public abstract class AppDatabase extends RoomDatabase {
    ...
    public abstract PetClothingCrossRefDao petClothingCrossRefDao();
